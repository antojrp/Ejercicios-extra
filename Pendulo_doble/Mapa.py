...
# Parámetros
# ========================================
file_in = "mapa.dat" # Nombre del fichero de datos
file_out = "mapa" # Nombre del fichero de salida (sin extensión)
...
for planet_pos, radius in zip(frames_data[0], planet_radius):
    ...
    planet_point = Circle((x, y), radius,color="#3e6525")
