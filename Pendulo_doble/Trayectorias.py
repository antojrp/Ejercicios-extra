...
# Parámetros
# ========================================
file_in = "trayectorias.dat" # Nombre del fichero de datos
file_out = "trayectorias" # Nombre del fichero de salida (sin extensión)
...
color=['#87189D','#3064A9','#00811F','#FFEF00','#FF8C00','#E70000']
...
for planet_pos, radius in zip(frames_data[0], planet_radius):
    ...
    planet_point = Circle((x, y), radius,color=color[i])
