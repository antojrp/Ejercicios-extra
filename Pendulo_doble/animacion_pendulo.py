...
# Parámetros
# ========================================
file_in = "pendulo.dat" # Nombre del fichero de datos
...
#planet_radius =  0.075 
planet_radius =  0 
color=['#87189D','#87189D','#3064A9','#3064A9','#00811F','#00811F','#FFEF00','#FFEF00','#FF8C00','#FF8C00']
...
time_template = 'Tiempo = %.1fsegundos'
